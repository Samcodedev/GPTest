...
const Navbar = ({setIsSidebarOpen, isSidebarOpen}) => {
  ...
  return (
    <aside className="navbar min-w-80 min-h-screen bg-[#3C38CE] text-white p-5 px-8 flex flex-col">
      ...
      <div className="bg-indigo-600 p-6 rounded-lg flex items-center justify-between">
      ...
      <nav className="mt-8">
        <ul className="flex flex-col gap-3">
          <li className="flex items-center mb-3 font-bold cursor-pointer">
          ...
          <li className="flex items-center mb-3 relative cursor-pointer">
