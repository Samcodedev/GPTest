  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-800 to-blue-900">
      <form className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-600">Username/ Email</label>
          <input 
            type="text" 
            required
        ...
        <div className="mb-4">
          <label className="flex justify-between text-sm font-medium text-gray-600">
            Password <a href="#" className="text-blue-600 text-xs">Remember me</a>
          </label>
          <input 
            type="password" 
        ...
        <button type="submit" className="w-full bg-[#3855B3] cursor-pointer text-white p-2 rounded-md hover:bg-blue-700 transition">
